...
<head>
	...
	<title>Hawasssa University Staffs Clearance Management System</title>
				...
				<div class="left_col scroll-view">
					...
					<div class="profile">
						<div class="profile_pic">
							<img src="..\images\kb.png" alt="..." class="img-circle profile_img">
						</div>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="">
								<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<img src="..\images\kb.png" alt=""><?php echo "$name"; ?>
			...
			<div class="right_col" role="main">
				<div class="">
							...
							<div class="x_content">
								<table id="datatable-buttons" class="table table-hover table-bordered">
									...
									<tbody>
										...
										$sql = "SELECT * FROM aca_staffs WHERE status = 0";
										...
										<tr>
											...
											<td><?php echo $value['aca_staffs_id'];?></td>
											<td><?php echo $value['aca_staffs_Fname'], '&nbsp;', $value['aca_staffs_Mname'], '&nbsp;', $value['aca_staffs_Lname']   ?></td>
											...
											<td class = "center" style = "text-align:center;">
												...
												<li class="dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <b> Customize </b> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
												...
												<li>	<a href = "#edit<?php echo $value ['id']?>" data-toggle="modal" class = "btn btn-success btn-xs"><i class = "fa fa-pencil"></i> Edit</a> </li>
													<input type="hidden" name="haydi" value="<?php echo $value ['id']?>">
													<li> <button type="submit" class="btn btn-primary btn-xs"><i class = "fa fa-eye"></i>View</button> </li>
												</form>
												<form action="../deactivate.php" method="POST">
													<input type="hidden" name="haydi" value="<?php echo $value ['id']?>">
													<li> <button type="submit" class="btn btn-danger btn-xs"><i class="fa fa-close"></i> Deactivate</button>  </li>
												</form>
												</ul>
                </li>
											</td>
